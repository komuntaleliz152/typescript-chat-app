...
export default function SmokingPage() {
  ...
  const handleContinue = () => {
    // TODO: Save smoking preference to backend
    console.log('Smoking:', selectedOption);
    router.push('/children'); // Go to step 9
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-2xl">
          <div className="text-8xl font-bold text-pink-600 mb-8 text-center">8</div>
